...
export const site = {
  ...
  serviceArea: {
    ...
    sentence:
      "Russell Springs, Jamestown, Somerset, Columbia, Monticello, Albany, Campbellsville, Liberty, Burkesville, Greensburg, Whitley City, and the surrounding counties — Russell, Pulaski, Adair, Wayne, Clinton, Casey, Taylor, Cumberland, Green, and McCreary.",
  },
  travelFee: {
    inTown: 0,
    surrounding: 25,
